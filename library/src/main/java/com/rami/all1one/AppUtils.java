...
public final class AppUtils {
    ...
    public  boolean isAppSystem() {
        return isAppSystem(context.getPackageName());
    }
     ...
     * @return {@code true}: yes<br>{@code false}: no
     */
    public  boolean isAppSystem(final String packageName) {
    ...
    public  boolean isAppForeground() {
        return !isSpace(getAppPackageName()) && getAppPackageName().equals(getForegroundProcessName());
    }
    ...
    public  void launchAppDetailsSettings() {
        launchAppDetailsSettings(context.getPackageName());
    }
     ...
     * @param packageName The name of the package.
     */
    public  void launchAppDetailsSettings(final String packageName) {
     ...
     * @return the application's path
     */
    public  String getAppPath(final String packageName) {
        if (isSpace(packageName)) return "";
        try {
            PackageManager pm = context.getPackageManager();
            PackageInfo pi = pm.getPackageInfo(packageName, 0);
     ...
     * @return the application's information
     */
    public  AppInfo getAppInfo(final String packageName) {
        try {
            PackageManager pm = context.getPackageManager();
            PackageInfo pi = pm.getPackageInfo(packageName, 0);
     ...
     * @return the application's package information
     */
    public  AppUtils.AppInfo getApkInfo(final File apkFile) {
     ...
     * @return the application's package information
     */
    public  AppUtils.AppInfo getApkInfo(final String apkFilePath) {
        ...
        if (android.os.Build.VERSION.SDK_INT > android.os.Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {// Access to usage information.
                ApplicationInfo info =
                        pm.getApplicationInfo(getAppPackageName(), 0);
                AppOpsManager aom =
